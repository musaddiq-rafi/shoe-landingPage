...
const PopularProducts = () => {
  return (
    ...
    >
      ...
      <p className='lg:max-w-lg mt-2 font-montserrat text-slate-gray'>Discover our most popular products that customers love. 
        From the latest sneakers to stylish apparel, find the perfect items to elevate your wardrobe.</p>
      </div>
